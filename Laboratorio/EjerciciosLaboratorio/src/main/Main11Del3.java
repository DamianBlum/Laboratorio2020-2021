...
public class Main11Del3 {
    public static void main(String[] argum){
        ...
        */
        ...
        persona2.setTelefono(1144556312);
        System.out.println("Edad de la tercera persona: "+persona3.getEdad());
        System.out.println("DNI de la tercera persona: "+persona3.getDNI());
        System.out.println("Telefono de la tercera persona: "+persona3.getTelefono());
        System.out.println("Nombre de la tercera persona: "+persona3.getNombre());
        System.out.println("Direccion de la tercera persona: "+persona3.getDireccion());
