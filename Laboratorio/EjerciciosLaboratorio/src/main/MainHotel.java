...
public class MainHotel {
    ...
    ArrayList<Huesped> top6Huepedes (ArrayList<Huesped> listaHuespedes){
        ...
        for (Huesped huespedLista:listaHuespedes){
            ...
            */
            for (int i = 0 ; j < top6Huespedes.size() ; j++) {
                if ((huespedLista.getCantVisitas() > (top6Huespedes.get(j)).getCantVisitas()){
                    top6Huespedes=desplazarListaPersonas(huespedLista,top6Huespedes,i);
                    i=top6Huespedes.size();
                }
            }
        }
    ...
    ArrayList<Huesped> huespedesEnDeterminadaHabitacion ( ArrayList<Hospedaje> listaHospedajes, int numeroHabitación) {
