...
public class Veterinaria {
    ...
    ArrayList<Mascota2> listaMascotas = new ArrayList<>();
    ...
    public String ingresoNombreMascota(boolean estado){ //true = baja o modificar / false = alta
        ...
        do {
            ...
            for (Mascota2 mascota_aux : listaMascotas) {
        ...
        do {
            ...
            switch (eleccion) {
                ...
                case 3:
                    ...
                    for (int i = 0; i < veterinaria.listaMascotas.size(); i++) {
                        Mascota2 mascota_aux = veterinaria.listaMascotas.get(i);
